    ...
    <div id="header">
        ...
        <div id="navcontainer">
            <ul id="navlist">
                ...
                <li id="inactive"><a href="about.php">Who are we?</a></li>
                <li id="inactive"><a href="themes.php">Research Themes</a></li>
                <li id="inactive"><a href="events.php">Events</a></li>
            </ul>
        </div>
        <div class="clearfloat"></div>
        <div><img src="images/lake.jpg" alt="" class="headerimg"/></div>
    </div>
    <!-- end #header -->
    <!-- begin #contentBody -->
    <div id="contentBody">
      ...
      <div class="solutions">
            ...
            <p>
            	...
            	<img src="images/bird.jpg" alt="" height="122" class="picFloat" />
          <span style="font-size: 16px">Massey Geoinformatics Collaboratory is a network of researchers in different departments and campuses of  Massey University who work with geographic information and conduct research in geoinformatics.</span></p>
          <p>&nbsp;</p>
          <p>The Collaboratory was established in June 2016 with support from the University's Strategic Innovation Fund, and will hold its inaugural face to face meeting on 10 August, 2016 in Palmerston North, New Zealand.</p>
          <p>&nbsp;</p>
          <p>The Collaboratory includes researchers from computer science, information technology, human and physical geography, planning, soil science, geomorphology and disaster management  at Massey's Auckland, Palmerston North and Wellington campuses.</p>
          <p>&nbsp;</p>
        <p>In the coming months, a virtual research environment will be established to support collaboration both within and beyond the University, providing access to resources, facilities for virtual seminars and discussion fora.</p>
        <p>&nbsp;</p>
          <p>&nbsp;</p>
    ...
    <div id="footercontainer">
        ...
        <br />
            ...
            <div class="footerContact">
    	      <p><a href="mailto:k.stock@massey.ac.nz(Dr%20Kristin%20Stock)?subject=Query%20about%20Geoinformatics%20Collaboratory">Contact us</a> if you would like to take part and join Massey University Geoinformatics Collaboratory</p>
